...
class RemoveAttendeeToWorkshopControllerTest extends ApiTestCase
{
    public function test_it_should_add_an_attendee_to_a_workshop(): void
    {
        ...
        $this->browser->request('POST', '/workshops/667731df-0a66-4030-9589-e8ab850a209b/attendees/remove/f6ac0c74-ca77-4b3b-9829-8c0cfe29cf44', [], [], ['HTTP_Authorization' => 'Bearer '.$this->getUserToken()]);
