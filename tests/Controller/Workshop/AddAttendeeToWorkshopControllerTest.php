...
class AddAttendeeToWorkshopControllerTest extends ApiTestCase
{
    public function test_it_should_add_an_attendee_to_a_workshop(): void
    {
        ...
        $this->browser->request('POST', '/workshops/e5444459-db7f-42a8-9a93-7925d4ffd1dc/attendees/add/e9a95edb-9b49-42f4-bf2d-7206fd65bc94', [], [], ['HTTP_Authorization' => 'Bearer '.$this->getUserToken()]);
